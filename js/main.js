...
//   element.querySelector('.picture__comments').textContent = avatar.message;
//   element.querySelector('.picture__likes').textContent = avatar.like;
//   element.querySelector('.picture__img').src = avatar.avatar;
//   return element;
// }
